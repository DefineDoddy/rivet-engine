package org.rivetengine.rendering.mesh.obj.importer;

import me.definedoddy.engine.rendering.mesh.Mesh;
import me.definedoddy.engine.rendering.mesh.MeshMap;
import me.definedoddy.engine.rendering.mesh.obj.Vertex;
import me.definedoddy.engine.rendering.mesh.obj.VertexData;
...
public class ModelImporter {
    ...
    public static Mesh importModel(File file) {
        return importModel(file, new Material());
    }

    public static Mesh importModel(File file, Material material) {
        ModelImporter importer = new ModelImporter(file);
        importer.importMaterials();
        importer.importMeshes();
        return new Mesh(new MeshMap(importer.meshData), material);
    }
