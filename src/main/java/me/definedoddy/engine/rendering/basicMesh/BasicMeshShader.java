...
public class BasicMeshShader extends Shader {
    ...
    private final UniformTexture texture = new UniformTexture("texSampler");

    public BasicMeshShader(ProjectFile vertexFile, ProjectFile fragmentFile) {
        super(vertexFile, fragmentFile, "in_position", "in_texCoords");
    }
    ...
    public static BasicMeshShader create() {
        ...
        shader.setUniforms(shader.texture);
        shader.validate();
        return shader;
    }
